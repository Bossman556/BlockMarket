# blockmarket - A Modern Fullstack E-Commerce Marketplace for Digital Products

Built with the Next.js 14 App Router, tRPC, TypeScript, Payload & Tailwind

![Project Image](https://github.com/joschan21/blockmarket/blob/master/public/thumbnail.jpg)
...
try {
    ...
    from: 'blockmarket <hello@joshtriedcoding.com>',
    to: [user.email],
...
<Html>
    <Head />
    <Preview>Your blockmarket Receipt</Preview>
    ...
    <Container style={container}>
        ...
        Copyright © 2023 blockmarket Inc. <br />{' '}
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to blockmarket, the marketplace for high quality digital
...
export function constructMetadata({
  title = 'blockmarket - the marketplace for digital assets',
  description = 'blockmarket is an open-source marketplace for high-quality digital goods.',
  image = '/thumbnail.png',
  icons = '/favicon.ico',
  noIndex = false,
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://blockmarket.up.railway.app'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false,
